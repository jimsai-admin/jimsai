...
$allowedKeys = @(
    ...
    "JIMS_ENABLE_NEO4J","JIMS_EMBEDDING_SERVICE_URL","JIMS_EMBEDDING_SERVICE_TOKEN",
    "JIMS_ENABLE_MULTIMODAL_ENCODERS","JIMS_MULTIMODAL_ENCODER_MODE",
    "JIMS_MULTIMODAL_ENCODER_URL","JIMS_MULTIMODAL_ENCODER_API_KEY",
    "JIMS_ENABLE_GROQ_T1","JIMS_ENABLE_GROQ_T2",
